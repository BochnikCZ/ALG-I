...
int main()
{
	...
	for (int i = 0; i < input_data_converted.size(); i++)
	{
		cout << input_data_converted[i]->GetDate().year << input_data_converted[i]->GetDate().month << input_data_converted[i]->GetDate().day << endl;
		cout << input_data_converted[i]->GetTime().hour << input_data_converted[i]->GetTime().minute << input_data_converted[i]->GetTime().second << endl;
		cout << input_data_converted[i]->GetBattery() << endl;
		cout << input_data_converted[i]->GetTemperature() << endl;
		cout << input_data_converted[i]->GetHumidity() << endl;
		cout << "//////////////////////////////////////////////////////////////////////////" << endl;
	}
